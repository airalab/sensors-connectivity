...
def main():
    ...
    if args.c:
        ...
        settings["stassid"] = input("WiFi name: ")
        settings["stapsk"] = input("WiFi's password: ")
        settings["host"] = input("Host [34.90.113.108]: ") or "34.90.113.108"
        settings["port"] = input("Port [31313]: ") or 31313
        settings["geo"] = input("GEO location: ")
